...
* CLIJ2_binaryFillHoles(Image source, Image destination)
...
* CLIJ2_concatenateStacks(Image stack1, Image stack2, Image destination)
* CLIJ2_connectedComponentsLabeling(Image binary_input, Image labeling_destination)
* CLIJ2_connectedComponentsLabelingBox(Image binary_input, Image labeling_destination)
* CLIJ2_connectedComponentsLabelingDiamond(Image binary_input, Image labeling_destination)
...
* CLIJ2_entropyBox(Image input, Image destination, Number radiusX, number radiusY, Number radiusZ)
...
* CLIJ2_floodFillDiamond(Image source, Image destination, Number value_to_replace, Number value_replacement)
...
* CLIJ2_sumImageSliceBySlice(Image source, Image destination)
...
* CLIJx_generateWekaProbabilityMaps(Image featureStack3D, Image probabilityMap3D_destination, String loadModelFilename)
...
* CLIJx_skeletonize(Image source, Image destination)
