...
```
Ext.CLIJ2_drawMeshBetweenNNearestLabels(Image input, Image destination, Number number_of_closest_labels);
```
...
clij2.drawMeshBetweenNNearestLabels(input, destination, number_of_closest_labels);
</pre>
