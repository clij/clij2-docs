...
```
Ext.CLIJ2_maximum3DSphere(Image source, Image destination, Number radiusX, Number radiusY, Number radiusZ);
```
...
cle.maximum_sphere(clij, source, destination, radiusX, radiusY, radiusZ)
</pre>
