...
```
Ext.CLIJ2_minimumBox(Image source, Image destination, Number radiusX, Number radiusY);
```
...
clij2.minimumBox(source, destination, radiusX, radiusY);
</pre>
...
cle.minimum_box(clij, source, destination, radiusX, radiusY)
</pre>
