...
```
Ext.CLIJ2_varianceBox(Image source, Image destination, Number radius_x, Number radius_y, Number radius_z);
```
...
clij2.varianceBox(source, destination, radius_x, radius_y, radius_z);
</pre>
