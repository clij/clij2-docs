## localMeanTouchingNeighborCountMap
...
clijx.localMeanTouchingNeighborCountMap(input, destination);
</pre>
...
cle.local_mean_touching_neighbor_count_map(input, destination)
