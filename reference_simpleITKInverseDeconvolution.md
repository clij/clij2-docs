...
```
Ext.CLIJx_simpleITKInverseDeconvolution(Image input, Image input_psf, Image destination, Number kernelZeroMagnitudeThreshold, Boolean normalize);
```
...
float kernelZeroMagnitudeThreshold = 1.0;
boolean normalize = true;
</pre>

<pre class="highlight">
// Execute operation on GPU
clijx.simpleITKInverseDeconvolution(input, input_psf, destination, kernelZeroMagnitudeThreshold, normalize);
</pre>
...
destination = clijx.create(input);
kernelZeroMagnitudeThreshold = 1.0;
normalize = true;
</pre>
