...
```
Ext.CLIJ2_maximumBox(Image source, Image destination, Number radiusX, Number radiusY);
```
...
clij2.maximumBox(source, destination, radiusX, radiusY);
</pre>
...
cle.maximum_box(clij, source, destination, radiusX, radiusY)
</pre>
