...
```
Ext.CLIJ2_standardDeviationIntensityMap(Image intensity_image, Image label_map, Image destination);
```
...
clij2.standardDeviationIntensityMap(intensity_image, label_map, destination);
</pre>
