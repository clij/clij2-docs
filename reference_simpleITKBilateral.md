...
```
Ext.CLIJx_simpleITKBilateral(Image input, Image destination, Number domainSigma, Number rangeSigma, Number numberOfRangeGaussianSamples);
```
...
float domainSigma = 1.0;
float rangeSigma = 2.0;
float numberOfRangeGaussianSamples = 3.0;
</pre>

<pre class="highlight">
// Execute operation on GPU
clijx.simpleITKBilateral(input, destination, domainSigma, rangeSigma, numberOfRangeGaussianSamples);
</pre>
...
domainSigma = 1.0;
rangeSigma = 2.0;
numberOfRangeGaussianSamples = 3.0;
</pre>
