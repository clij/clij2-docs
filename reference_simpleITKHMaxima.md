...
Suppress local maxima whose height above the baseline is less than h.See also: https://simpleitk.org/doxygen/latest/html/classitk_1_1simple_1_1HMaximaImageFilter.html
...
```
Ext.CLIJx_simpleITKHMaxima(Image input, Image destination, Number h);
```
...
clijx.simpleITKHMaxima(input, destination, h);
</pre>
