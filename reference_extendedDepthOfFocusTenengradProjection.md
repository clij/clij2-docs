...
```
Ext.CLIJ2_extendedDepthOfFocusTenengradProjection(Image source, Image destination, Number sigma);
```
...
clij2.extendedDepthOfFocusTenengradProjection(source, destination, sigma);
</pre>
