...
```
Ext.CLIJx_imageJVariance(Image input, Image destination, Number sigma_x, Number sigma_y, Number sigma_z);
```
...
clijx.imageJVariance(input, destination, sigma_x, sigma_y, sigma_z);
</pre>
