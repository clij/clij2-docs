...
```
Ext.CLIJ2_labelMinimumIntensityMap(Image intensity_image, Image label_map, Image destination);
```
...
clij2.labelMinimumIntensityMap(intensity_image, label_map, destination);
</pre>
...
cle.label_minimum_intensity_map(intensity_image, label_map, destination)
