...
```
Ext.CLIJ2_dilateSphereSliceBySlice(Image source, Image destination);
```
...
clij2.dilateSphereSliceBySlice(source, destination);
</pre>
...
cle.dilate_sphere_slice_by_slice(clij, source, destination)
</pre>
