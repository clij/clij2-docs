...
```
Ext.CLIJx_greyscaleClosingSphere(Image source, Image destination, Number radius_x, Number radius_y, Number radius_z);
```
...
clijx.greyscaleClosingSphere(source, destination, radius_x, radius_y, radius_z);
</pre>
