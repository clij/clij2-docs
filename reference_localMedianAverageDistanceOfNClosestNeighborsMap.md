## localMedianAverageDistanceOfNClosestNeighborsMap
...
```
Ext.CLIJx_localMedianAverageDistanceOfNClosestNeighborsMap(Image input, Image destination, Number n);
```
...
clijx.localMedianAverageDistanceOfNClosestNeighborsMap(input, destination, n);
</pre>
