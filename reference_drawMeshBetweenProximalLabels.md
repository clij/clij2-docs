...
```
Ext.CLIJ2_drawMeshBetweenProximalLabels(Image input, Image destination, Number maximum_distance);
```
...
clij2.drawMeshBetweenProximalLabels(input, destination, maximum_distance);
</pre>
