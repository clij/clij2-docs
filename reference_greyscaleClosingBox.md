...
```
Ext.CLIJx_greyscaleClosingBox(Image source, Image destination, Number radius_x, Number radius_y, Number radius_z);
```
...
clijx.greyscaleClosingBox(source, destination, radius_x, radius_y, radius_z);
</pre>
