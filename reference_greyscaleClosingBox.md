...
```
Ext.CLIJ2_greyscaleClosingBox(Image source, Image destination, Number radius_x, Number radius_y, Number radius_z);
```
...
clij2.greyscaleClosingBox(source, destination, radius_x, radius_y, radius_z);
</pre>
