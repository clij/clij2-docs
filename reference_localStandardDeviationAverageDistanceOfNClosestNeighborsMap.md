...
```
Ext.CLIJx_localStandardDeviationAverageDistanceOfNClosestNeighborsMap(Image input, Image destination, Number n);
```
...
clijx.localStandardDeviationAverageDistanceOfNClosestNeighborsMap(input, destination, n);
</pre>
