...
```
Ext.CLIJ2_greyscaleOpeningSphere(Image source, Image destination, Number radius_x, Number radius_y, Number radius_z);
```
...
clij2.greyscaleOpeningSphere(source, destination, radius_x, radius_y, radius_z);
</pre>
