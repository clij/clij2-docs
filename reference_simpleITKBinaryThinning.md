...
See also: https://simpleitk.org/doxygen/latest/html/classitk_1_1simple_1_1BinaryThinningImageFilter.html
...
```
Ext.CLIJx_simpleITKBinaryThinning(Image input, Image destination);
```
...
clijx.simpleITKBinaryThinning(input, destination);
</pre>
