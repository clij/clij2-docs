...
```
Ext.CLIJ2_minimum3DSphere(Image source, Image destination, Number radius_x, Number radius_y, Number radius_z);
```
...
clij2.minimum3DSphere(source, destination, radius_x, radius_y, radius_z);
</pre>
