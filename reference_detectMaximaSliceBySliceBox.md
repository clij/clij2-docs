...
```
Ext.CLIJ2_detectMaximaSliceBySliceBox(Image source, Image destination, Number radiusX, Number radiusY);
```
...
clij2.detectMaximaSliceBySliceBox(source, destination, radiusX, radiusY);
</pre>
