...
```
Ext.CLIJ2_labelMaximumExtensionMap(Image input, Image destination);
```
...
clij2.labelMaximumExtensionMap(input, destination);
</pre>
...
cle.label_maximum_extension_map(input, destination)
