...
See also: https://simpleitk.org/doxygen/latest/html/classitk_1_1simple_1_1BinomialBlurImageFilter.html
...
```
Ext.CLIJx_simpleITKBinomialBlur(Image input, Image destination, Number repetitions);
```
...
float repetitions = 1.0;
</pre>

<pre class="highlight">
// Execute operation on GPU
clijx.simpleITKBinomialBlur(input, destination, repetitions);
</pre>
